      ...
      <div style={{ maxWidth: '1180px', width: '100%', margin: '0 auto', textAlign: 'center', position: 'relative', zIndex: 1, flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
        ...
        <div ref={stageRef} style={{
          ...
          <div style={{
            ...
            <m.div
              {...bob(-8, 4)}
              style={{ ...pillStyle, top: '32%', left: isMobile ? '-20px' : '-35px' }}
            >
            ...
            <m.div
              {...bob(8, 5, 0.5)}
              style={{ ...pillStyle, bottom: '18%', left: isMobile ? '-15px' : '-35px' }}
            >
            ...
            <m.div
              {...bob(-10, 4.5, 0.2)}
              style={{ ...pillStyle, top: '32%', right: isMobile ? '-20px' : '-35px' }}
            >
            ...
            <m.div
              {...bob(8, 5.5, 0.7)}
              style={{ ...pillStyle, bottom: '8%', right: isMobile ? '-15px' : '-35px' }}
            >
